...
function serialize_graphqleditor_messages_TextStreamRequest(arg) {
  if (!(arg instanceof messages_messages_pb.TextStreamRequest)) {
...
function deserialize_graphqleditor_messages_TextStreamRequest(buffer_arg) {
  return messages_messages_pb.TextStreamRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_graphqleditor_messages_TextStreamResponse(arg) {
  if (!(arg instanceof messages_messages_pb.TextStreamResponse)) {
...
function deserialize_graphqleditor_messages_TextStreamResponse(buffer_arg) {
  return messages_messages_pb.TextStreamResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var TextStreamServiceService = exports.TextStreamServiceService = {
  textStream: {
    ...
    requestStream: false,
    responseStream: true,
    requestType: messages_messages_pb.TextStreamRequest,
    responseType: messages_messages_pb.TextStreamResponse,
